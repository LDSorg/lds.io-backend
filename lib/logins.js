...
module.exports.createController = function (config, DB, ContactNodes) {
  ...
  */
  ...
  Logins.createLoginOnly = function (secret, recoverynodes) {
    ...
    return $login
      .save(
        { uid: randomId
        , type: 'local'
        , hashid: secretutils.md5sum('local:' + randomId)
        , shadow: creds.shadow
        , salt: creds.salt
  ...
  Logins.create = function (contactnodes, secret, opts) {
    ...
    return Logins.claimContactNodes(contactnodes, opts).then(function ($contactnodes) {
      return Logins.createLoginOnly(secret, opts.recoverynodes).then(function ($login) {
  ...
  */
  ...
  Logins.login = function (type, node, secret/*, tokens*/) {
    type = type || ContactNodes.getNodeType(node);
...
module.exports.createView = function (config, DB, manualLogin, ContactNodes) {
  ...
  Logins.restful.check = function (req, res) {
    ...
    // TODO check type
    var promise = Logins.checkMultiauth(req.params.type, req.params.node).then(function (multiauth) {
