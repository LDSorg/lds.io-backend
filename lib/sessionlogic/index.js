...
module.exports.init = function (app, passport, config, Auth, Logins) {
  ...
  function loginWrapper(req, res, next, loginResults) {
  ...
  function loginWithBearerToken(req, res, next) {
  ...
  function controlApiAccess(req, res, next) {
    console.log('TODO: set req.$client instead of hard-coding');
  ...
  var bearerHelpers = bearer.create(passport, config, Auth, loginWrapper);
  ...
  app
    ...
    .use(loginWithBearerToken)
    .use(config.apiPrefix, controlApiAccess)
    ;
