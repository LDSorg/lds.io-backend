...
module.exports.createController = function (/*config, DB*/) {
  ...
  LdsConnect.photo = function (config, $account, params/*, opts*/) {
    ...
    , lastSessionAt: $account.get('lastSessionAt')
      ...
      // cache all images, but stagger them between 15 and 45 minutes
      var age = Math.floor(Math.random() * (15 * 60 * 1000)) + (45 * 60 * 1000);
...
module.exports.create = module.exports.createRouter = function (app, config, DB, ContactNodes) {
  ...
  function route(rest) {
    ...
    rest.get('/:accountId/photos/:photoType/:photoId/:photoSize/:whatever.jpe?g', requireLdsAccount, LdsConnect.restful.photo);
