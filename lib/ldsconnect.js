    ...
    var promise = LdsConnect.profile(config, req.$account, { expire: req.query.expire }).then(function (p) {
      ...
      */
      ...
      if (sensitive) {
        ...
        , homeWardAppScopedId: cipher(p.homeWardId, secret)
        /*
    ...
    var promise = new PromiseA(function (resolve) {
      var accounts = req.oauth3.accounts$.map(function ($account) {
        ...
        result = {
          ...
          , emailVerifiedAt: $account.get('public').emailVerifiedAt || '1970-01-01T00:00:00.000Z'
          , phoneVerifiedAt: $account.get('public').phoneVerifiedAt || '1970-01-01T00:00:00.000Z'
          , userVerifiedAt: $account.get('public').userVerifiedAt || '1970-01-01T00:00:00.000Z'
        };
